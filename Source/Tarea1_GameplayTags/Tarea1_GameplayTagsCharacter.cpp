...
{
	if(const TSubclassOf<UBaseAttack> PrimaryAttack = CharacterAttributes->PrimaryAttack)
	{
		PrimaryAttack->GetDefaultObject<UBaseAttack>()->Attack(GetOwner());
	}
}
